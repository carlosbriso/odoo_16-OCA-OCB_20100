...
def-env activate-virtualenv [] {
    ...
    let virtual_env = '/opt/odoo/odoo_16/odoo_16-OCA-OCB_20100-virtualenv-wrapper'
    let bin = 'bin'
    let path_sep = ':'
...
alias deactivate = source '/opt/odoo/odoo_16/odoo_16-OCA-OCB_20100-virtualenv-wrapper/bin/deactivate.nu'
